...
const experiences = [
  ...
  },
  {
    ...
    company: "RSX (Robotics for Space Exploration) · UofT Design Team · Toronto, ON",
...
const projects = [
  {
    ...
    techs: ["React", "Vite", "JavaScript", "CSV Parser", "React Hooks", "Context API"],
    duration: "1 week",
    teamSize: "Solo",
    btnLink: "",
  ...
  },
  {
    ...
    techs: ["C++", "OpenStreetMap", "Custom Graphics Engine", "A*", "Dijkstra", "TSP Algorithms", "Multithreading", "libcurl", "JSON"],
    duration: "4 months",
  ...
  },
  {
    ...
    techs: ["C", "RISC-V", "FPGA (DE1-SoC)", "ADSR Envelope", "VGA", "PS/2", "Real-Time Systems"],
    duration: "2 months",
  ...
  },
  {
    ...
    techs: ["Arduino", "C/C++", "Ultrasonic Sensors", "Color Sensors", "DC Motors", "Embedded Systems"],
    duration: "2 days",
    teamSize: "6",
    btnLink: "",
    btnIcon: "fab fa-github",
  ...
  },
  {
    ...
    techs: ["Django", "Python", "SQLite3", "Bootstrap", "HTML/CSS", "User Authentication"],
    duration: "2 weeks",
    teamSize: "Solo",
    btnLink: "",
    btnIcon: "fab fa-github",
  ...
  },
  {
    ...
    techs: ["Verilog", "FPGA (DE1-SoC)", "VGA", "On-Chip Memory", "ModelSim", "Git"],
    duration: "2 months",
    teamSize: "2",
    btnLink: "",
    btnIcon: "fas fa-file-powerpoint",
  ...
  },
  {
    ...
    techs: ["Python", "Flask", "CNN", "HTML", "CSS", "JavaScript", "PyTorch", "Transfer Learning"],
    duration: "3 months",
    teamSize: "2 members",
    btnLink: "",
    btnIcon: "fab fa-github",
